...
- テスト用ファームウェア [handyman_test.hex](https://github.com/Taro-Hayashi/Handyman/releases/download/14.15/handyman_test.hex)
...
- [handyman_via.hex](https://github.com/Taro-Hayashi/Handyman/releases/download/14.15/handyman_via.hex)
