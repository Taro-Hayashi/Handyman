...
レバースイッチを取り付けます。
取り付け難易度が高いので使わなさそうであれば無視してしまっても構いません。
...
レバースイッチの二股に分かれているところははんだが乗りにくいので無理に接着しなくても構いません。

リセットスイッチを裏から差し込み表ではんだ付けします。  
![](img/reset.png)   

キースイッチを表から差し込みます。  
ここの二つのスイッチはPro Microと干渉する可能性があるので、足を切ってからはんだ付けします。
![](img/keyswitch1.jpeg)  
![](img/keyswitch2.jpeg)  
